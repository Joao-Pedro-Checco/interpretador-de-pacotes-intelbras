package br.com.fulltime.fullarm.core.message.status.partial;
...
public class PartialStatusMessage extends GenericPackageMessage {
    ...
    public PartialStatusMessage() {
        super(MessageType.PARTIAL_STATUS);
    }
