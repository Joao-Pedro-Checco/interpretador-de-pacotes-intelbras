package br.com.fulltime.fullarm.infra.processor.command.subcommand.centraldeactivation;
...
@Service
public class CentralDeactivationProcessorImpl implements CentralDeactivationProcessor {
    ...
    public Subcommand process(String argument) {
        ...
        CentralDeactivation centralDeactivation = new CentralDeactivation();
        centralDeactivation.setPartitions(partitions);
    ...
    public boolean canProcess(String arguments) {
        ...
        boolean subcommandIdentifierIsValid = SubcommandIdentifier.getByValue(bytes.get(0)) == SubcommandIdentifier.CENTRAL_DEACTIVATION;
