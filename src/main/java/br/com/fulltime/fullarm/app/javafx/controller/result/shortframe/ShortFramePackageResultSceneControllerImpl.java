package br.com.fulltime.fullarm.app.javafx.controller.result.shortframe;
...
@Component
@Scope("prototype")
public class ShortFramePackageResultSceneControllerImpl implements ShortFramePackageResultSceneController {
    @FXML
    ...
    public void displayResult(String rawPackage, List<String> message) {
        ...
        packageDescriptionLabel.setText(message.get(1));
    }
